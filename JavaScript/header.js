...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const createProductCard = (product) => {
        ...
        // const newPriceHTML = product["new-price"]
        //     ? `<span class="new-price">${product["new-price"]}</span>`
        //     : "";
    ...
    // تابع جدید برای کارت با استایل متفاوت
    ...
    // بارگذاری و نمایش محصولات در دو بخش
    fetch('./products.json')
        .then(response => {
        ...
        .then(products => {
            ...
            function renderAlternativeSection(productList, wrapperId, btnId) {
                ...
                addLikeFunctionality();  // همان تابع قبلی کار می‌کند چون کلاس .like-btn یکسان است
                convertNode(wrapper);
