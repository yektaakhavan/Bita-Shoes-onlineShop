...
fetch("./json/products.json")
  ...
  .then((products) => {
    ...
    renderProducts(
      products.filter((p) => p.categories?.includes("Amazing Offer")),
    ...
    const interval = setInterval(() => {
      ...
      if (distance < 0) {
        ...
        timerElement.innerHTML =
          '<span style="font-size:1.6em; font-weight:bold; color:var(--color-secondary100);">منقضی شد!</span>';
